...
export default function HomePage() {
  return (
    <div className="min-h-screen bg-slate-900 text-white font-sans selection:bg-pulse-cyan/30">
      ...
      <nav className="flex justify-between items-center p-6 border-b border-slate-800 bg-slate-900/80 backdrop-blur-md sticky top-0 z-50">
        ...
        <div className="hidden md:flex gap-6 text-sm font-medium text-slate-400">
          ...
          <Link href="/dashboard" className="text-white bg-slate-800 px-4 py-1.5 rounded-full border border-slate-700">Dashboard</Link>
        </div>
      ...
      <main className="max-w-7xl mx-auto px-6 pt-20 pb-24">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center mb-32">
          <div className="space-y-8">
            ...
            <div className="flex flex-wrap items-center gap-4 pt-4">
              <Link href="/dashboard" className="bg-pulse-cyan text-slate-900 px-6 py-3 rounded-lg font-semibold hover:bg-cyan-400 transition-all shadow-[0_0_20px_rgba(6,182,212,0.4)] flex items-center gap-2">
            ...
            <div className="bg-slate-800 border border-slate-700/50 rounded-2xl p-6 shadow-2xl relative z-10">
              ...
              <div className="grid grid-cols-3 gap-4 mb-8">
                <div className="bg-slate-900 p-4 rounded-xl border border-slate-700">
                  ...
                  <p className="text-2xl font-bold text-pulse-green">41 <span className="text-sm font-normal text-slate-500">km/h</span></p>
                </div>
                <div className="bg-slate-900 p-4 rounded-xl border border-slate-700">
                  <p className="text-slate-400 text-xs mb-1">DENSITY</p>
                  <p className="text-2xl font-bold text-pulse-yellow">44 <span className="text-sm font-normal text-slate-500">v/km</span></p>
                </div>
                <div className="bg-slate-900 p-4 rounded-xl border border-slate-700">
        ...
        <div className="mb-32">
          <div className="mb-12">
            ...
            <p className="text-slate-400">From CBD bottlenecks to the suburbs — every interchange, every minute.</p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            <div className="bg-slate-800 border border-slate-700 p-6 rounded-xl hover:border-slate-500 transition-colors">
              ...
              <p className="text-slate-400 text-sm leading-relaxed">Leaflet-powered dark map with color-coded nodes across six corridors.</p>
            </div>
            <div className="bg-slate-800 border border-slate-700 p-6 rounded-xl hover:border-slate-500 transition-colors">
              <Gauge className="text-pulse-green mb-4" size={28} />
              <h3 className="text-lg font-semibold mb-2">Real-time metrics</h3>
              <p className="text-slate-400 text-sm leading-relaxed">Vehicle counts, speeds and density updated every few seconds.</p>
            </div>
            <div className="bg-slate-800 border border-slate-700 p-6 rounded-xl hover:border-slate-500 transition-colors">
              <TrendingUp className="text-pulse-yellow mb-4" size={28} />
              <h3 className="text-lg font-semibold mb-2">2-hour forecasts</h3>
              <p className="text-slate-400 text-sm leading-relaxed">Predictive congestion modelling so you know exactly when to leave.</p>
            </div>
            <div className="bg-slate-800 border border-slate-700 p-6 rounded-xl hover:border-slate-500 transition-colors">
              <Shield className="text-pulse-red mb-4" size={28} />
              <h3 className="text-lg font-semibold mb-2">Operator-grade</h3>
              <p className="text-slate-400 text-sm leading-relaxed">Hotspot ranking and historical trends for planners and dispatch.</p>
            </div>
          </div>
        </div>

        {/* Bottom CTA */}
        <div className="relative overflow-hidden rounded-2xl bg-gradient-to-br from-slate-800 to-slate-900 border border-slate-700 p-12 text-center">
          ...
          <p className="text-slate-400 mb-8 max-w-md mx-auto">Access the live dashboard immediately. Connects directly to the backend simulator pipeline.</p>
          
          <Link href="/dashboard" className="inline-flex items-center gap-2 bg-pulse-cyan text-slate-900 px-8 py-3 rounded-lg font-semibold hover:bg-cyan-400 transition-all shadow-[0_0_20px_rgba(6,182,212,0.4)]">
